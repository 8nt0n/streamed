...
def register(srcDir, seriesTargetDir, seasonNum, inclPattern, exclPattern, mediaRepoDir, createSymlink, seriesTitle, seriesDescr):
    targetSeasonDir = os.path.join(mediaRepoDir, "audios", seriesTargetDir, seasonNum) # TODO: use constant               
    ...
    for fsElem in orderedFiles:
        ...
        if cmn.isAudioFile(srcPath) and inclPattern.fullmatch(fsElem) != None and exclPattern.fullmatch(fsElem) == None:
